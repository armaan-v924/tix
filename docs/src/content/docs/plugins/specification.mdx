...
description: The normative contract between tix and a plugin.
sidebar:
  order: 2
---

The authoritative reference for writing a tix plugin: the contract as
shipped. It is normative — where this and a guide disagree, this wins.
...
in Rust ([API docs](/crates/tix_sdk/)), the
...
([`tix-sdk/examples/toy-plugin.rs`](https://github.com/armaan-v924/tix/blob/main/tix-sdk/examples/toy-plugin.rs) is a complete working plugin.)
...
[`tix-sdk/PROTOCOL.md`](https://github.com/armaan-v924/tix/blob/main/tix-sdk/PROTOCOL.md).
